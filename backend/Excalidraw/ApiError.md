...
- **`package com.example.blog.dto;`**: This specifies the Java package where the class resides. The use of `dto` (Data Transfer Object) in the name indicates that this class is primarily used for **transferring data** between the service layer and the external world (the client).
